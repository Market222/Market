    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">销售</font></font>
                <small><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">添加订单</font></font>
                </small>
            </h2>
        ...
        <div class="x_content row">
            <br>
            <form class="form-horizontal form-label-left input_mask" action="/OrangBank/insertMarketBack">
                ...
                <div  class="form-group">
                    <label for="market_shooppingid" class="col-sm-2 control-label">商品名称：</label>
                    <div class="col-sm-3">
                        <select class="form-control" name="market_shooppingid" style="height: 3rem;line-height: 50px" id="market_shooppingid">
                            <c:if test="${Market != null }">
                                <option value="0">--请选择--</option>
                                <c:forEach var="Market" items="${Market}">
                                    <option <c:if test="${Market.shoopping.shoopping_id == market_shooppingid }">selected="selected"</c:if>
                                            value="${Market.shoopping.shoopping_id}">${Market.shoopping.shoopping_name}</option>
                                </c:forEach>
                            </c:if>
                        </select>
                    </div>
                ...
                <div  class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control has-feedback-left" name="marketBack_count" id="marketBack_count"/>
                    </div>
                </div>
                ...
                <div  class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control has-feedback-left" name="marketBack_address" id="marketBack_address"/>
                    </div>
                </div>
                ...
                <div  class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control has-feedback-left" name="marketBack_salesman" id="marketBack_salesman"/>
                    </div>
                </div>

                <div  class="form-group">
                    <label for="marketBack_preparedby" class="col-sm-2 control-label">制单人：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control has-feedback-left" name="marketBack_preparedby" id="marketBack_preparedby"/>
                    </div>
                </div>

                <div  class="form-group">
                    <label for="marketBack_remark" class="col-sm-2 control-label">备注：</label>
                    <div class="col-sm-3">
                        <input type="text" class="form-control has-feedback-left" name="marketBack_remark" id="marketBack_remark"/>
                    </div>
                </div>
