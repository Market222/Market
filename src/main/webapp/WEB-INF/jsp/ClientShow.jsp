...
<ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
    ...
    <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab"
            ...
            style="vertical-align: inherit;">我的客户详情</font></font></a>
    </li>
</ul>
<div class="main">
    ...
    <div class="x_panel">
        <div class="x_title">
            <h2><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">详情</font></font>
                <small><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">客户详情</font></font>
                </small>
            </h2>
        ...
        <div class="x_content">
            ...
            <form class="form-horizontal form-label-left input_mask">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    客户ID：<input type="text" class="form-control" value="${client.client_id}" readonly="readonly">
                </div>

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    联系人:<input type="text" class="form-control" value="${client.client_name}" readonly="readonly">
                </div>

                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    送货地址:<input type="text" class="form-control" value="${client.client_address}" readonly="readonly">
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    座机: <input type="text" class="form-control has-feedback-left" readonly="readonly"
                                 value="${client.client_specialplane}"/>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    销售员:<input type="text" class="form-control" value="${client.client_salesman}" readonly="readonly">
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                    销售发票号: <input type="text" class="form-control has-feedback-left" readonly="readonly"
                                 value="${client.client_invoice}"/>
                </div>
                <div class="clearfix"></div>
